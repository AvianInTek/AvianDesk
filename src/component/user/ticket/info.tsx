...
export default function TicketInfo() {
    ...
    <div className="space-y-6">
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 font-bold">
        ...
        <div>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 font-bold">
                ...
                <div className="text-base fond-medium space-y-2 text-gray-700">
                    <a className="items-left text-blue-500" href="mailto:dean.taylor@gmail.com"><span className="text-gray-400 items-right">Email:</span> dean.taylor@gmail.com</a>
                    <p className="items-left"><span className="text-gray-400 items-right">Phone:</span> Unknown</p>
                    <p className="items-left"><span className="text-gray-400 items-right">Location:</span> Colombo (View on map)</p>
                    <p className="items-left"><span className="text-gray-400 items-right">Local time:</span> 06:30 am (+5.30 GMT)</p>
                    <p className="items-left"><span className="text-gray-400 items-right">Language:</span> English</p>
                </div>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
            <h3 className="font-bold text-gray-800 mb-3">Files Shared</h3>
            <div className="space-y-2">
            <div className="flex items-center space-x-2 bg-gray-100 p-2 rounded-lg">
                <img src="/pdf.svg" alt="pdf" className="w-6 h-6" />
                <p className="text-sm text-gray-800">error-number.jpg</p>
            </div>
            <div className="flex items-center space-x-2 bg-gray-100 p-2 rounded-lg">
